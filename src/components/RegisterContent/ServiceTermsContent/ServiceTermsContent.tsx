    ...
    <Container>
      ...
      <TermsArea>
        <Terms>
          ...
          미만 아동의 개인정보 처리 시 법정대리인의 동의여부 확인, 각종
          고지·통지 목적으로 개인정보를 처리합니다.
          <br />
          개인정보 제 3자 제공 동의 <br /> <br /> 제 1 조 (목적) 본 약관은
          {"<쇼핑폼>"}(이하 '쇼핑폼')은(는)의 제반 서비스의 이용조건 및 절차에
          관한 사항 및 기타 필요한 사항을 규정함을 목적으로 합니다. <br />제 2
          조 (용어의 정의) 본 약관에서 사용하는 용어는 다음과 같이 정의 합니다.
      ...
      <AgreeButtonArea>
        <AgreeButton onClick={handleNextClick}>다음</AgreeButton>
      </AgreeButtonArea>
    </Container>
  );
};
